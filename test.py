...
#         self._observer = NSEvent.addLocalMonitorForEventsMatchingMask_handler_(
#             NSLeftMouseDownMask
#             | NSLeftMouseUpMask
...
#     def stop(self):
#         print("stop")
#         NSEvent.removeMonitor_(self._observer1)

# try:        
#     m = MacOSXEventMonitor()

#     while True:
#         print("Wait")
#         time.sleep(1)
# except KeyboardInterrupt:
#     print("\nCtr-C has been entered")
...
# # while True:
# #     #if med.clicked or med.moved or med.scrolled:
# #     print med.isAlive(), med.is_alive(), med.clicked, med.moved, med.scrolled
# #     med.reset()
# #     time.sleep(1)# Copyright 2012 Bjarte Johansen
...
from Cocoa import (
    ...
    NSLeftMouseDown, NSLeftMouseUpMask, NSLeftMouseDownMask, NSLeftMouseDraggedMask,
    NSRightMouseDown, NSRightMouseUpMask, NSRightMouseDownMask, NSRightMouseDraggedMask,
...
class AppDelegate:
    ...
    def applicationDidFinishLaunching_(self, notification):
        ...
        #mask = (NSKeyDown)
        #NSEvent.addLocalMonitorForEventsMatchingMask_handler_(mask, self.handler)
